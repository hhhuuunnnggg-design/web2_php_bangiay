...
<div style="display: flex;justify-content: space-between;">
    ...
    <div>
        <?php if ($auth->checkPermission(5, 'add')): ?>
            <a style="text-decoration: none;" href="/shoeimportsystem/public/index.php?controller=employee&action=add">
        ...
        <?php if ($auth->checkPermission(5, 'export')): ?>
            <a style="text-decoration: none;" href="/shoeimportsystem/public/index.php?controller=employee&action=export">
                ...
                <tr data-id="<?php echo $row['MaNV']; ?>">
                    ...
                    <td>
                        <?php if ($auth->checkPermission(5, 'edit')): ?>
                            <a style="text-decoration: none;" href="/shoeimportsystem/public/index.php?controller=employee&action=edit&id=<?php echo $row['MaNV']; ?>">
