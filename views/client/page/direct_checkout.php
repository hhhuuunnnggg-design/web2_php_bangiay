    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form id="checkout-form">
                <input type="hidden" name="maSP" value="<?php echo htmlspecialchars($directItem['MaSP']); ?>">
                <input type="hidden" name="size" value="<?php echo htmlspecialchars($directItem['Size']); ?>">
                <input type="hidden" name="color" value="<?php echo htmlspecialchars($directItem['MaMau']); ?>">
                <input type="hidden" name="quantity" value="<?php echo htmlspecialchars($directItem['SoLuong']); ?>">
                <div class="mb-3">
        ...
        <div class="col-md-6">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        <td><img src="/shoeimportsystem/public/<?php echo htmlspecialchars($directItem['Img']); ?>" alt="<?php echo htmlspecialchars($directItem['TenSanPham']); ?>" style="width: 50px; height: 50px;"></td>
                        <td><?php echo htmlspecialchars($directItem['TenSanPham']); ?></td>
                        <td><?php echo htmlspecialchars($directItem['SoLuong']); ?></td>
                        <td><?php echo number_format($directItem['GiaTien'], 0, ',', '.') . ' VNĐ'; ?></td>
                        <td><?php echo number_format($directItem['TongTien'], 0, ',', '.') . ' VNĐ'; ?></td>
                    </tr>
                </tbody>
            </table>
            <h4>Tổng tiền: <?php echo number_format($directItem['TongTien'], 0, ',', '.') . ' VNĐ'; ?></h4>
        </div>
    </div>
</div>
