<!-- shoeimportsystem/views/client/page/search_results.php -->
<?php
session_start();
...
<body>
    ...
    <main style="margin-top: 230px;">
        <div class="container mt-5" style="margin-bottom: 180px;">
            <?php if (isset($productsByCategory) && is_array($productsByCategory) && !empty($productsByCategory['search']['products'])): ?>
                <div class="product-grid">
                    <?php foreach ($productsByCategory['search']['products'] as $product): ?>
